class CentralProblem:
    ...
    def __init__(self):
        self._target_coefs = [1, -2, -1, -3]  # this list represents the sum of agents cost vectors
        self._individual_resources = [[4], [9]]  # agents individual resources
        self._individual_coefs = [[2], [1], [2], [3]]  # agents individual coefficients
        self._shared_resources = [[8], [5]]  # agents shared resources
        self._shared_coefs = [[1, 1], [3, 1], [2, 1], [1, 1]]  # agents shared coefficients
